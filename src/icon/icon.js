...
class Icon {
    constructor(el) {
        ...
        this.templates = {
            "360": require("./templates/360._svg"),
            binoculars: require("./templates/binoculars._svg"),
            blogger: require("./templates/blogger._svg"),
            ...
            `,
            download: require("./templates/save._svg"),
            ...
            `,
            save: require("./templates/save-disk._svg"),
